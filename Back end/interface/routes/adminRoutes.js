...
router.get('/reject_hotel/:email',jwt.verifyToken,admincontroller.rejectRequest)
router.get('/view_details/:email',jwt.verifyToken,admincontroller.hotelIncompleteDetails)
router.get('/hotelIncompleteDetailsPage',jwt.verifyToken,admincontroller.hotelIncompleteDetailsPage)
